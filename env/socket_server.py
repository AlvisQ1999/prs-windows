    ...
    def __init__(self, stop_event):
        ...
        while not sock_result:
            try:
                ...
                serve_port += 1
                tcp_address = ('localhost', serve_port)
        with open('unity/PRS-Env_Data/StreamingAssets/config.json', 'r') as file:
            env_data = json.load(file)
        env_data["serverConnectionPort"] = serve_port
        with open('unity/PRS-Env_Data/StreamingAssets/config.json', 'w') as file:
...
class ObjectsData(object):
    def __init__(self):
        with open('unity/PRS-Env_Data/StreamingAssets/itemInfo.json', 'r') as file:
    ...
    def segment(self):
        with open('unity/PRS-Env_Data/StreamingAssets/segmentationTagColorInfo.json', 'r') as file:
...
class PrsEnv(object):
    def __init__(self, is_print=1, rendering=1, start_up_mode=0):
        ...
        executable_path = './unity/PRS-Env.exe'
        if rendering:
